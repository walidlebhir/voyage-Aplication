    ...
    <div class="main-content">
        ...
        <main class="table-section">
            <div class="content">
                ...
                <button class="ajouter"><a href="#"  style="text-decoration:none; color:#fff;"><i class="fa-solid fa-plus"></i>  ajouter</a></button>
            </div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <?php
                        ...
                        $requetSql = "SELECT * FROM reservation "; 
                        $variablestmnt = $pdo->prepare($requetSql); 
                        $variablestmnt->execute(); 
                        $donnesreservations = $variablestmnt->fetchAll(PDO::FETCH_ASSOC); 
                        
                        
                        foreach($donnesreservations as $donnesreservation ){
                            ?>

                                <tr>
                                    <td><?php  echo $donnesreservation['id_reservation'] ?></td>
                                    <td><?php  echo    $donnesreservation['id_compt']   ?></td>
                                    <td><?php  echo     $donnesreservation['idvoyage']   ?></td>
                                    <td><?php  echo    $donnesreservation['Nom']   ?></td>
                                    <td><?php  echo     $donnesreservation['Email']  ?></td>
                                    <td><?php  echo $donnesreservation['numero_cart'] ?></td>
                                    <td class="action">
